...
namespace Application.Services 
{
    public class EmailService
    {
        ...
        public Task Execute(string UserEmail, string Body, string Subject)
        {
            ...
            client.Credentials = new NetworkCredential("Shop.Styleto@gmail.com", "12341380Fa!");
            MailMessage message = new MailMessage("Shop.Styleto@gmail.com", UserEmail, Subject, Body);
